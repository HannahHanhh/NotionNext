...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xiao Han', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个贝果脆🥯', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-hannahhanhhs-projects.vercel.app/', // 网站地址
